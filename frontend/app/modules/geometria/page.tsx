...
const TypewriterAnimation: React.FC<{ onComplete: () => void }> = ({ onComplete }) => {
  ...
  const text = "¡Bienvenido al Mundo de la Geometría! 📐✨";
  ...
  useEffect(() => {
    ...
    const typeInterval = setInterval(() => {
      if (index < text.length) {
        ...
        // Mostrar por 3 segundos después de terminar de escribir
        setTimeout(() => {
          onComplete();
        }, 3000);
      }
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="fixed inset-0 bg-gradient-to-br from-purple-100 via-pink-50 to-violet-100 flex items-center justify-center z-50"
    >
      {/* Elementos geométricos flotantes animados */}
      <div className="absolute inset-0 overflow-hidden">
        {[...Array(15)].map((_, i) => (
          ...
          >
            {i % 3 === 0 && (
              <div className="w-8 h-8 bg-purple-300 rounded-full opacity-40" />
            )}
            {i % 3 === 1 && (
              <div className="w-8 h-8 bg-pink-300 opacity-40" />
            )}
            {i % 3 === 2 && (
              <div 
                className="w-8 h-8 bg-violet-300 opacity-40"
      ...
      <motion.div
        ...
        className="text-center px-8 py-12 bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-purple-200 max-w-2xl mx-4"
      >
        {/* Icono animado de geometría */}
        <motion.div
          initial={{ rotate: 0, scale: 0 }}
          animate={{ rotate: 360, scale: 1 }}
          transition={{ duration: 1, ease: "backOut", delay: 0.3 }}
          className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-purple-400 to-pink-400 rounded-2xl flex items-center justify-center shadow-lg"
        >
          <img
        ...
        >
          <motion.div
            ...
            className="w-8 h-8 bg-purple-400 rounded-full shadow-lg"
          />
          <motion.div
            animate={{ 
              rotate: [0, -360],
            ...
            className="w-8 h-8 bg-pink-400 shadow-lg"
          />
          <motion.div
            animate={{ 
              rotate: [0, 360],
            ...
            className="w-8 h-8 bg-violet-400 shadow-lg"
            style={{ clipPath: "polygon(50% 0%, 0% 100%, 100% 100%)" }}
          />
        </motion.div>
        ...
        <motion.div
          ...
          className="h-1 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full mt-8 mx-auto max-w-xs"
        />
      </motion.div>
    </motion.div>
  );
...
const GeometriaPage: React.FC = () => {
  ...
  // Función para manejar el fin de la animación de typewriter
  ...
  useEffect(() => {
    if (showTypewriter) return; // No ejecutar animaciones GSAP mientras se muestra el typewriter
  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-50 relative overflow-hidden"
      >
        ...
        <div className="container mx-auto max-w-7xl p-4 sm:p-6 relative z-10">
          ...
          <div ref={videoSectionRef} className="mb-6 sm:mb-8 opacity-0">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl sm:rounded-2xl p-4 sm:p-8 border border-purple-500 hover:shadow-xl transition-all duration-500 group">
              ...
              <div
                className="relative bg-gradient-to-br from-purple-100 to-pink-100 rounded-2xl sm:rounded-3xl border-2 sm:border-4 border-purple-600 p-4 sm:p-8 flex flex-col items-center justify-center min-h-[200px] sm:min-h-[300px] cursor-pointer group hover:from-purple-200 hover:to-pink-200 transition-all duration-300 hover:scale-[1.02]"
