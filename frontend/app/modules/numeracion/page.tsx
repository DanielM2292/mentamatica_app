...
import { ArrowLeft, Play, Star, Circle, Coins, X } from "lucide-react";
...
const Button: React.FC<ButtonProps> = ({
  ...
  const variants: Record<ButtonVariant, string> = {
    primary: "bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white shadow-lg hover:shadow-xl focus:ring-blue-400",
    ghost: "bg-transparent hover:bg-blue-100 text-blue-700 hover:text-blue-800 focus:ring-blue-400"
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto p-3 sm:p-6 relative z-10">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl sm:rounded-2xl p-4 sm:p-8 border border-blue-100 hover:shadow-xl transition-all duration-500 group">
            ...
            >
              ...
              <div className="absolute bottom-2 sm:bottom-4 left-1/2 transform -translate-x-1/2 flex gap-1 sm:gap-2">
                {[1, 2, 3, 4, 5].map((num) => (
                  <div key={num} className="flex items-center justify-center w-2 h-2 sm:w-6 sm:h-6 bg-white/50 rounded-full text-xs font-bold text-blue-700">
        ...
        {/* Fun Fact Section */}
        <div ref={funFactRef} className="mt-6 sm:mt-8 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-blue-100 opacity-0">
          <div className="text-center">
            ...
            <p className="text-sm sm:text-base text-blue-700 break-words">
              Los números están en todas partes: tu edad, los dedos de tus manos, las horas del día... 
              ¡Aprender a contar te ayuda a entender el mundo!
            </p>
          </div>
        </div>
      </div>
