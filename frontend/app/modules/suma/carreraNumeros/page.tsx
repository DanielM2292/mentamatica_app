            ...
            <div className="mt-4 sm:mt-6 space-y-4 sm:space-y-6" ref={gameContainerRef}>
              ...
              <Card
                className={`bg-white/95 backdrop-blur-lg border-2 border-green-300 shadow-2xl hover:shadow-green-200/50 transition-all duration-500 ${
                  animatedElements.has("race") ? "animate-bounce-in" : "opacity-0"
                }`}
              ...
              >
                <CardContent className="p-6 sm:p-8">
                  ...
                  <div className="text-center mt-4">
                    <Badge
                      className={`text-sm px-4 py-2 font-bold shadow-lg ${
                        playerPosition >= 80
              ...
              <Card
                className={`bg-white/95 backdrop-blur-lg border-2 border-yellow-300 shadow-2xl hover:shadow-yellow-200/50 transition-all duration-500 ${
                  animatedElements.has("input") ? "animate-bounce-in" : "opacity-0"
                }`}
