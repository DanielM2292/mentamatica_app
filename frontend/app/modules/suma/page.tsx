...
import { ArrowLeft, Play, Star, Plus, Coins, X } from "lucide-react";
...
const Button: React.FC<ButtonProps> = ({
  ...
  const variants: Record<ButtonVariant, string> = {
    primary: "bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white shadow-lg hover:shadow-xl focus:ring-green-400",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto p-3 sm:p-6 relative z-10">
          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl sm:rounded-2xl p-4 sm:p-8 border border-green-100 hover:shadow-xl transition-all duration-500 group">
            ...
            >
              ...
              <div className="absolute bottom-2 sm:bottom-4 left-1/2 transform -translate-x-1/2 flex gap-1 sm:gap-4 items-center">
                {[1, 2, 3].map((num) => (
                  <div key={num} className="flex items-center justify-center w-2 h-2 sm:w-6 sm:h-6 bg-white/50 rounded-full text-xs font-bold text-green-700">
        ...
        {/* Fun Fact Section */}
        <div ref={funFactRef} className="mt-6 sm:mt-8 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-green-100 opacity-0">
          <div className="text-center">
          ...
          <div className="video-modal bg-white rounded-2xl p-4 sm:p-6 max-w-4xl w-full max-h-[90vh] overflow-hidden">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg sm:text-xl font-bold text-gray-800">
                La Suma para Niños - Aprende a Sumar
              </h3>
              <Button
